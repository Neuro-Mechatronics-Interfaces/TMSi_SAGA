classdef SensorChannelType0 < TMSiSAGA.HiddenHandle
    ...
    methods
        function obj = SensorChannelType0(sensor, channel_number, data)
            ...
            %
            %   obj = SensorChannelType0(sensor, channel_number, data)
            %
            %   Constructor for a type 0 sensor channel.
            %
            %   obj [out] - SensorChannelType0 object.
            %   sensor [in] - Parent sensor
            %   channel_number [in] - The channel number this channel is located at.
            %   data [in] - The raw byte data of a structure that has to be parsed.
            %
        ...
        function linkChannel(obj, channel)
            ...
            %
            %   obj [in] - SensorChannelType0 object.
        ...
        function samples = transform(obj, samples)
            ...
            %
            %   samples [out/in] - Samples that need to be transformed            
            %   obj [in] - SensorChannelType0 object.
            %
