function StimHreflexTMSiTesting
close all
clear all %#ok<CLALL>.
global handles
global s0
...
% Callback functions
    ...
    function PlotData
        ...
        handles.PlotLineHandles(1) = line(PlotDomain(1:PlotSpacing:end),Trig(1:PlotSpacing:end,:),'Parent',handles.PlotHandles(1),'Color',rand(1,3)); %plot the data from a channel
